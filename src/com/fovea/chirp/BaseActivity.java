...
public class BaseActivity extends Activity { // <1>
  ChirpApplication chirp; // <2>

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    chirp = (ChirpApplication) getApplication(); // <3>
  }
  ...
  public boolean onOptionsItemSelected(MenuItem item) { // <5>
    ...
    case R.id.itemToggleService:
      ...
      break;
    case R.id.itemPurge:
      ((ChirpApplication) getApplication()).getStatusData().delete();
