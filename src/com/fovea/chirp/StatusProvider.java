...
public class StatusProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse(
			"content://com.fovea.chirp.statusprovider");
	public static final String SINGLE_RECORD_MIME_TYPE = 
			"vnd.android.cursor.item/vnd.fovea.chirp.status";
	public static final String MULTIPLE_RECORDS_MIME_TYPE = 
			"vnd.android.cursor.dir/vnd.fovea.chirp.mstatus";
	...
	public Cursor query(Uri uri, String[] projection, String whereClause, 
		...
		if (id < 0) {
			return db.query(StatusData.TABLE, projection, whereClause, 
	...
	public int update(Uri uri, ContentValues values, 
		...
		try {
			if (id < 0) {
				return db.update(StatusData.TABLE, values, whereClause, whereArgs);
			} else {
				return db.update(
						StatusData.TABLE, values, StatusData.C_ID + "=" + id, null);
			}
		} finally {
			db.close();
		}
